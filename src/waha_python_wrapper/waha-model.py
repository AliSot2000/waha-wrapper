...
#   filename:  openapi_formatted.json
#   timestamp: 2024-07-01T21:36:09+00:00
...
class WebhookConfig(BaseModel):
    ...
    hmac: HmacConfiguration | None = None
    retries: RetriesConfiguration | None = None
    customHeaders: List[CustomHeader] | None = None
...
class SessionConfig(BaseModel):
    ...
    noweb: NowebConfig | None = Field(
        None, example={'store': {'enabled': True, 'fullSync': False}}
    )
...
class SessionInfo(BaseModel):
    ...
    config: SessionConfig | None = None
    me: MeInfo | None = None
    engine: Engine | None = Field(None, example='WEBJS')
...
class Contact(BaseModel):
    ...
    organization: str | None = Field(
        None, description='The organization of the contact', example='Company Name'
    )
    phoneNumber: str = Field(
        ..., description='The phone number of the contact', example='+91 11111 11111'
    )
    whatsappId: str | None = Field(
        None,
...
class WAMessage(BaseModel):
    ...
    ack: Ack = Field(..., description='ACK status for the message')
    ackName: str = Field(..., description='ACK status name for the message')
    author: str | None = Field(
        None,
        description='If the message was sent to a group, this field will contain the user that sent the message.',
    )
    location: WALocation | None = Field(
        None,
        description='Location information contained in the message, if the message is type "location"',
    )
    vCards: List[str] | None = Field(
        None, description='List of vCards contained in the message.'
    )
    field_data: str | None = Field(
        None,
        alias='_data',
...
class BinaryFile(BaseModel):
    ...
    filename: str | None = Field(
        None, description='Document file name. Optional', example='filename.jpeg'
    )
    data: str = Field(
        ...,
...
class WAHAPresenceData(BaseModel):
    ...
    lastSeen: float | None = Field(None, example=1686568773)
...
class WAHAEnvironment(BaseModel):
    ...
    tier: str = Field(..., example='PLUS')
    browser: str = Field(..., example='/usr/path/to/bin/google-chrome')
...
class WAHAWebhookMessage(BaseModel):
    ...
    session: str = Field(..., example='default')
    engine: Engine = Field(..., example='WEBJS')
    event: Event = Field(..., description='Incoming message.')
    payload: WAMessage
    me: MeInfo | None = None
    environment: WAHAEnvironment
...
class WAMessageAckBody(BaseModel):
    ...
    from_: str = Field(..., alias='from', example='11111111111@c.us')
    to: str = Field(..., example='11111111111@c.us')
    participant: str = Field(..., example='11111111111@c.us')
    fromMe: bool
    ack: Ack
    ackName: str
...
class WAHAWebhookGroupJoin(BaseModel):
    ...
    session: str = Field(..., example='default')
    engine: Engine = Field(..., example='WEBJS')
    event: Event = Field(..., description='Some one join a group.')
    payload: Dict[str, Any]
    me: MeInfo | None = None
    environment: WAHAEnvironment
...
class WAHAWebhookGroupLeave(BaseModel):
    ...
    session: str = Field(..., example='default')
    engine: Engine = Field(..., example='WEBJS')
    event: Event = Field(..., description='Some one left a group.')
    payload: Dict[str, Any]
    me: MeInfo | None = None
    environment: WAHAEnvironment
...
class PollVote(BaseModel):
    ...
    selectedOptions: List[str] = Field(
        ..., description='Option that user has selected', example=['Awesome!']
    )
    timestamp: float = Field(..., description='Timestamp, ms', example=1692861369)
    to: str
